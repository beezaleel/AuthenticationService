...
PROTOBUF_NAMESPACE_OPEN
template<> ::authenticate::AuthenticateWeb* Arena::CreateMaybeMessage<::authenticate::AuthenticateWeb>(Arena*);
template<> ::authenticate::AuthenticateWebFailure* Arena::CreateMaybeMessage<::authenticate::AuthenticateWebFailure>(Arena*);
template<> ::authenticate::AuthenticateWebSuccess* Arena::CreateMaybeMessage<::authenticate::AuthenticateWebSuccess>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace authenticate {
...
class AuthenticateWeb final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:authenticate.AuthenticateWeb) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "authenticate.AuthenticateWeb";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:authenticate.AuthenticateWeb)
 private:
  class _Internal;
...
class AuthenticateWebSuccess final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:authenticate.AuthenticateWebSuccess) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "authenticate.AuthenticateWebSuccess";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:authenticate.AuthenticateWebSuccess)
 private:
  class _Internal;
...
class AuthenticateWebFailure final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:authenticate.AuthenticateWebFailure) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "authenticate.AuthenticateWebFailure";
  }
  protected:
  ...
  ::authenticate::AuthenticateWebFailure_reason failurereason() const;
  void set_failurereason(::authenticate::AuthenticateWebFailure_reason value);
  private:
  ::authenticate::AuthenticateWebFailure_reason _internal_failurereason() const;
  void _internal_set_failurereason(::authenticate::AuthenticateWebFailure_reason value);
  public:

  // @@protoc_insertion_point(class_scope:authenticate.AuthenticateWebFailure)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 AuthenticateWeb::requestid() const {
  // @@protoc_insertion_point(field_get:authenticate.AuthenticateWeb.requestId)
...
inline void AuthenticateWeb::set_requestid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:authenticate.AuthenticateWeb.requestId)
}
...
inline const std::string& AuthenticateWeb::email() const {
  // @@protoc_insertion_point(field_get:authenticate.AuthenticateWeb.email)
...
void AuthenticateWeb::set_email(ArgT0&& arg0, ArgT... args) {
 ...
 email_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:authenticate.AuthenticateWeb.email)
}
inline std::string* AuthenticateWeb::mutable_email() {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:authenticate.AuthenticateWeb.email)
  return _s;
}
...
inline std::string* AuthenticateWeb::release_email() {
  // @@protoc_insertion_point(field_release:authenticate.AuthenticateWeb.email)
...
inline void AuthenticateWeb::set_allocated_email(std::string* email) {
  ...
  // @@protoc_insertion_point(field_set_allocated:authenticate.AuthenticateWeb.email)
}
...
inline const std::string& AuthenticateWeb::plaintextpassword() const {
  // @@protoc_insertion_point(field_get:authenticate.AuthenticateWeb.plaintextPassword)
...
void AuthenticateWeb::set_plaintextpassword(ArgT0&& arg0, ArgT... args) {
 ...
 plaintextpassword_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:authenticate.AuthenticateWeb.plaintextPassword)
}
inline std::string* AuthenticateWeb::mutable_plaintextpassword() {
  std::string* _s = _internal_mutable_plaintextpassword();
  // @@protoc_insertion_point(field_mutable:authenticate.AuthenticateWeb.plaintextPassword)
  return _s;
}
...
inline std::string* AuthenticateWeb::release_plaintextpassword() {
  // @@protoc_insertion_point(field_release:authenticate.AuthenticateWeb.plaintextPassword)
...
inline void AuthenticateWeb::set_allocated_plaintextpassword(std::string* plaintextpassword) {
  ...
  plaintextpassword_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), plaintextpassword,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:authenticate.AuthenticateWeb.plaintextPassword)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 AuthenticateWebSuccess::requestid() const {
  // @@protoc_insertion_point(field_get:authenticate.AuthenticateWebSuccess.requestId)
  return _internal_requestid();
}
...
inline void AuthenticateWebSuccess::set_requestid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_requestid(value);
  // @@protoc_insertion_point(field_set:authenticate.AuthenticateWebSuccess.requestId)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 AuthenticateWebSuccess::userid() const {
  // @@protoc_insertion_point(field_get:authenticate.AuthenticateWebSuccess.userId)
...
inline void AuthenticateWebSuccess::set_userid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:authenticate.AuthenticateWebSuccess.userId)
}
...
inline const std::string& AuthenticateWebSuccess::creationdate() const {
  // @@protoc_insertion_point(field_get:authenticate.AuthenticateWebSuccess.creationDate)
...
void AuthenticateWebSuccess::set_creationdate(ArgT0&& arg0, ArgT... args) {
 ...
 creationdate_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:authenticate.AuthenticateWebSuccess.creationDate)
}
inline std::string* AuthenticateWebSuccess::mutable_creationdate() {
  std::string* _s = _internal_mutable_creationdate();
  // @@protoc_insertion_point(field_mutable:authenticate.AuthenticateWebSuccess.creationDate)
  return _s;
}
...
inline std::string* AuthenticateWebSuccess::release_creationdate() {
  // @@protoc_insertion_point(field_release:authenticate.AuthenticateWebSuccess.creationDate)
...
inline void AuthenticateWebSuccess::set_allocated_creationdate(std::string* creationdate) {
  ...
  creationdate_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), creationdate,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:authenticate.AuthenticateWebSuccess.creationDate)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 AuthenticateWebFailure::requestid() const {
  // @@protoc_insertion_point(field_get:authenticate.AuthenticateWebFailure.requestId)
  return _internal_requestid();
}
...
inline void AuthenticateWebFailure::set_requestid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_requestid(value);
  // @@protoc_insertion_point(field_set:authenticate.AuthenticateWebFailure.requestId)
}
...
inline ::authenticate::AuthenticateWebFailure_reason AuthenticateWebFailure::_internal_failurereason() const {
  return static_cast< ::authenticate::AuthenticateWebFailure_reason >(failurereason_);
}
inline ::authenticate::AuthenticateWebFailure_reason AuthenticateWebFailure::failurereason() const {
  // @@protoc_insertion_point(field_get:authenticate.AuthenticateWebFailure.failureReason)
  return _internal_failurereason();
}
inline void AuthenticateWebFailure::_internal_set_failurereason(::authenticate::AuthenticateWebFailure_reason value) {
  assert(::authenticate::AuthenticateWebFailure_reason_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  failurereason_ = value;
}
inline void AuthenticateWebFailure::set_failurereason(::authenticate::AuthenticateWebFailure_reason value) {
  _internal_set_failurereason(value);
  // @@protoc_insertion_point(field_set:authenticate.AuthenticateWebFailure.failureReason)
}
...
template <> struct is_proto_enum< ::authenticate::AuthenticateWebFailure_reason> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::authenticate::AuthenticateWebFailure_reason>() {
  return ::authenticate::AuthenticateWebFailure_reason_descriptor();
}
